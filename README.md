...
hp
  - a most basic [random forest](https://github.com/carbasemin/kaggle_noob/blob/main/hp/model_basicRF.py), overfits to the training data, scores ~0.14 on the competition. Not even top %50.
